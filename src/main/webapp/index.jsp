<%--
    Document   : index
    Created on : Dec 10, 2021, 11:45:54 AM
    Author     : Timosamedet
--%>
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="images/pharmacie_icon.png">
	<!-- Meta tag Keywords -->
...
<body>
				...
				<div class="modal-body">
					<form action="authenticate" method="POST">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="userName" value="${JwtRequest.userName}" required="">
						</div>
						<div class="form-group">
							<label class="col-form-label">Password</label>
							<input type="password" class="form-control" placeholder=" " name="userPassword" value="${JwtRequest.userPassword}" required="">
						</div>
						<div class="right-w3l">
				...
				<div class="modal-body">
					<form action="registerNewUser" method="POST">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="enter your first name" name="userFirstName" value="${user.userFirstName}" required="">
						</div>
						<div class="form-group">
							<label class="col-form-label">UserName</label>
							<input type="text" class="form-control" placeholder="enter your username" name="userName" value="${user.userName}" required="">
						</div>
						<div class="form-group">
							<label class="col-form-label">Password</label>
							<input type="password" class="form-control" placeholder="enter your password " name="userPassword" id="password1" value="${user.userPassword}" required="">
						</div>
						<div class="form-group">
	...
	<div class="header-bot">
		<div class="container">
			<div class="row header-bot_inner_wthreeinfo_header_mid" style="margin-bottom: 5px;">
				<!-- logo -->
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="images/Real Colour_Resize.png" alt=" ">
						</a>
					</h1>
				</div>
				<!-- //logo -->
